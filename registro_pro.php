...
if (!empty($_POST)) {
    ...
    $producto = registrarproducto([$nombre, $description, $price,$stock,$image], $con); 
   ...
   <header>
    ...
    <main>
        <div class="container">
            ...
            <form class="row g-3" action="registro_pro.php" method="post" autocomplete="off">
                <div class="col-md-6">
                    <label for="nombres"><span class="text-danger">*</span>Nombre del producto</label>
                ...
                <div class="col-md-6">
                    <label for="correo"><span class="text-danger">*</span>Price</label>
                    <input type="number" name="price" id="price" class="form-control" required>
                </div>
                <div class="col-md-6">
                    <label for="usuario"><span class="text-danger">*</span>Stock</label>
